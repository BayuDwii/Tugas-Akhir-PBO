...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            ...
            <label for="cek2">
                <i class="fa fa-bars fs-2 ms-5 p-1" id="keluar" style="background-color: rgb(255, 246, 232); border-radius: 5px;"></i>
                <i class="fa fa-bars fs-2 ms-5 p-1" id="masuk" style="background-color: rgb(255, 246, 232); border-radius: 5px;"></i>
            </label>

            <div class="sidebar" style="background-color: rgb(232, 186,153);">
                <div class="judul-sidebar d-flex align-items-center justify-content-around mb-5 p-2" style="background-color: rgb(232, 186,153); border: 3px solid black; margin-top: -2rem;">
                    <h2>Menu</h2>
                </div>
